...
import { FirstRowGLTFResult, GrindrGLTFNodes, HealthGLTFNodes, SoundCloudGLTFNodes, XGLTFNodes } from './FirstRow.types';
...
const FirstRow = () => {
	...
	return (
		<group position={arrayToVector3([10, 90, 23])}>
			...
			<Grindr nodes={nodes as GrindrGLTFNodes} position={arrayToVector3([90, 0, 0])}/>
		</group>
	);
};
